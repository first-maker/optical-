...
# list for new model collection And nav chisses
cotgery=["Women","MEN","Kids","All"]

# list for   nav chisses
navList=["kid","sun","new","men" ,"woman","Kids","accessory","contactLenses"]


lens_cute=['McGreen', 'McBlue', 'HCate', 'BlueCut', 'Bluerized', 'Photo', 'Transition', 'Color','Clear','UV']

lens_index =['1.50','1.53','1.56','1.59','1.60','1.67','1.74','1.76']
power=[]
for x in np.arange(-20,2,0.25):
    x='{:05.2f}'.format(x)

    power.append(x)

typelist = ['Agent', 'Client', 'Insurance', 'Supplier']

#  brand list type of proudeact 
brand_list = [ 'Frams', 'Lens', 'ContactLens', 'Devices', 'Accessories', 'Othar']
